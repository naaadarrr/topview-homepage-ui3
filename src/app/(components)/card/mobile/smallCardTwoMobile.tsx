...
export default function SmallCardTwoMobile() {
  return (
    <Center mt="5rem">
      <Stack>
        <Heading
        ...
        <Stack w="100%" spacing="31px" justifyContent="center">
          <article>
            <Card
              w="370px"
              h="330px"
              ...
              <Stack>
                ...
                <Center>
                  <Text
                    ...
                    textAlign="center"
                  >
                    Translate your content across 29 languages in seconds with
                    voice translation, speaker detection, and audio dubbing
                  </Text>
                </Center>
              </Stack>
            </Card>
              ...
              <Stack>
                ...
                <Center>
                  <Text
                    ...
                    textAlign="center"
                  >
                    Access the largest community ad library in the world with
                    over 1,000,000 curated ads from 100k+ brands.
                  </Text>
                </Center>
              </Stack>
            </Card>
